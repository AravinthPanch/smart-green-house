 ...
 *
 ***********************************************************/
void drawPort_internal(int pos, int port, int type)
{
  if( type==0 ) // USB PORTS
  {
    switch( port )
...
void getSerialData(Serial port) 
{  
  drawLight(3.3);
  ...
  { 
    ...
    acc = float(split(trama1,','));
    bat_signal=int(acc[0]);
    acc_signal= int(acc[1]);
    valx = acc[2];
    valy = acc[3];
    valz = acc[4];  
  }
  ...
  { 
    ...
    eve = float(split(trama3,','));
    flag_event= int(eve[0]);
...
void drawAccelerometer()
{
  ...
  // rotate-X
  if ((valz<=1024.0)&&(valz>=-1024.0)) 
  {
    rotateX(asin(valz/1000.0));
  }
  else 
  {
    rotateX(asin(valz_old/1124.0));
  }
  ...
  if ((valy<=1024)&&(valy>=-1024)) 
  {
    ...
    {      
      if ((valy<=1024)&&(valy>0)) 
      {        
        rotateZ((-asin(valy/1000.0)-2*asin(valx/1000.0))); 
      }
      else
      {
        rotateZ((-asin(valy/1000.0)+2*asin(valx/1000.0))); 
    ...
    {      
      rotateZ(-asin(valy/1000.0)); 
    }
  }
  else 
  {
    rotateZ(-asin(valy_old/1124.0));  
  }
...
{ 
  ...
  text(int(light_signal*100/33),680,405);  
  drawLight(light_signal);
  
  noFill();
  fill(0);
  if( press2_signal<0 ) press2_signal=0;
  text(int((press2_signal/10)*4.54),680,227);
 ...
 *
 ***********************************************************/
void drawAxis_internal(int number, int Y, int axis){
  pushMatrix();
 ...
 *
 ***********************************************************/
void drawPressAtm(int press){

  int ang=230;

  if( (press>=90) && (press<98) ) ang+=(int) ( (press-90)*12.5 );
  else if( (press>=98) && (press<104) ) ang+=(int) ( (press-90)*13 );
  else if( (press>=104) && (press<108) ) ang+=(int) ( (press-90)*13.3 );
  else if( (press>=108) ) ang+=(int) ( (press-90)*13.1 );
 ...
 *
 ***********************************************************/
void drawLight(float light_signal){
...
void drawPress(float press)
{
  ...
  if( press2<0.5 ) image(press_0,620,130);
  else if( (press2>=0.5)&&(press2<0.78) ) image(press_10,620,130);
  else if( (press2>=0.78)&&(press2<1.06) ) image(press_20,620,130);
  else if( (press2>=1.06)&&(press2<1.34) ) image(press_30,620,130);
  else if( (press2>=1.34)&&(press2<1.62) ) image(press_40,620,130);
  else if( (press2>=1.62)&&(press2<1.9) ) image(press_50,620,130);
  else if( (press2>=1.9)&&(press2<2.18) ) image(press_60,620,130);
  else if( (press2>=2.18)&&(press2<2.46) ) image(press_70,620,130);
  else if( (press2>=2.46)&&(press2<2.74) ) image(press_80,620,130);
  else if( (press2>=2.74)&&(press2<3.02) ) image(press_90,620,130);
  else if( (press2>=3.02)&&(press2<3.3) ) image(press_100,620,130);
...
void drawBend(float bend){
  ...
  if( bend2<0.25 ) image(bend_0,615,490);
  else if( (bend2>=0.25)&&(bend2<0.5) ) image(bend_10,615,490);
  else if( (bend2>=0.5)&&(bend2<0.75) ) image(bend_20,615,490);
  else if( (bend2>=0.75)&&(bend2<1) ) image(bend_30,615,490);
  else if( (bend2>=1)&&(bend2<1.25) ) image(bend_40,615,490);
  else if( (bend2>=1.25)&&(bend2<1.5) ) image(bend_50,615,490);
  else if( (bend2>=1.5)&&(bend2<1.75) ) image(bend_60,615,490);
  else if( (bend2>=1.75)&&(bend2<2) ) image(bend_70,615,490);
  else if( (bend2>=2)&&(bend2<2.25) ) image(bend_80,615,490);
  else if( (bend2>=2.25) ) image(bend_90,615,490);
